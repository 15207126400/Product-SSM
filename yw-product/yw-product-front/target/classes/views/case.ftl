...
<div style="margin-bottom:50px;">
    <image style="width:100%;" src="${base}/image/case/banner.jpg" />
</div>
<#--客户案例-->
<div id="hiddenresult" style="display:none;width:100%;margin-top:50px;margin-bottom:80px;" class="app-column-center-layout">
	<#if qhzArticles?? && qhzArticles?size gt 0>
		<#list qhzArticles as qhzArticle>
			<div style="height:280px;padding-top:20px;padding-bottom:20px;border-bottom:1px solid #CCCCCC;" class="result app-row-between-layout">
				<div style="width:45%;height:100%;" class="app-row-center-layout">
					<image style="width:100%;height:100%;" src="${qhzArticle.img}" />
				</div>
				<div style="width:50%;height:100%;" class="app-column-start-left">
					<span style="font-size:16px;font-weight:bold;">${qhzArticle.title!''}</span>

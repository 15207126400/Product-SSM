...
<div style="width:100%;" class="app-column-center-layout">
	...
	<div class="job-top-nav-box app-row-between-layout">
		...
		<a href="${base}/job3.htm">
			<div class="app-column-center-layout">
				<image class="job-top-nav-img" src="${base}/image/job/nav_select_icon3.png" />
			...
			<div id="content" class="app-column-start-left">
				<div id="post-nav1-con" class="app-column-start-left">
					<div class="app-column-start-left">
						<h3 style="color:#0066C9;padding:20px;">程序员 8-13k/月</h3>
					</div>
					<div style="padding:10px 0px 0px 20px;" class="app-column-start-left">
						<span>岗位职责: </span>
						<span style="padding-left:20px;">1. 3-5年及以上 Java 开发经验；</span>
						<span style="padding-left:20px;">2. 熟练开发语言html，css，JavaScript，数据库sql语言，mysql数据库等使用，以及接口的调用；</span>
						<span style="padding-left:20px;">3. 熟悉jQuery，vue.js等前端框架；</span>
						<span style="padding-left:20px;">4. 熟悉缓存、消息、降级熔断、控流等机制，能对分布式常用技术进行合理应用；</span>
						<span style="padding-left:20px;">5. 掌握 Linux 基础操作，对 MySQL 原理及常用优化有一定了解；</span>
						<span style="padding-left:20px;">6. 拥有较好的学习能力，可以承受一定压力，善于分析、归纳、解决问题，能够持续学习、自我迭代；</span>
						<span style="padding-left:20px;">7. 负责公司公众号后台程序开发与维护。</span>
					</div>
					<div style="padding:10px 0px 0px 20px;" class="app-column-start-left">

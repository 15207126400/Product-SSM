...
public class YwTeamFollowController {
	...
	// 日志打印
    Logger logger = Logger.getLogger(YwTeamFollowController.class);
	...
	public String edit(YwTeamFollow ywTeamFollow,String op_type,Model model){
		...
		if(StringUtils.equals(op_type, "2")){
			model.addAttribute("ywTeamFollow", ywTeamFollowService.query(ywTeamFollow));
		} else {

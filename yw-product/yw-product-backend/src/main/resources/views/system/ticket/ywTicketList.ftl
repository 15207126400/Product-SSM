...
<@screen id="ywTicketList" title="抽奖配置" places=[{"name":"抽奖配置","href":"#"}]>
	...
	headItems=[
		...
		{"id":"school_name", "name":"抽奖人员部门职位"},
		{"id":"ticket_flag", "name":"设置是否中奖","dic_key":"1032"},
	...
	<div class="right-btn-box">
		<span class="input-group-btn">
			<a href="${base}/system/ywTicket/ticketShow.htm" target="_Blank">
				<button class="btn btn-success btn_text" type="button">抽奖</button>
			</a>
		</span>
	    <span class="input-group-btn">

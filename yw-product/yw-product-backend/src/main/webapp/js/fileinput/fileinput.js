    ...
    FileInput.prototype = {
        ...
        _showUploadError: function (msg, params, event) {
            ...
            var self = this, $error = self.$errorContainer, ev = event || 'fileuploaderror', e = params && params.id ?
            	...
            	// 修改为自定义提示
            		//'<li data-file-id="' + params.id + '">'+ msg +'</li>' : '<li>文件不正确，请重新检查</li>'
        ...
        _uploadSingle: function (i, isBatch) {
            ...
            fnSuccess = function (data, textStatus, jqXHR) {
                ...
                setTimeout(function () {
                    ...
                    if (data.error_no == "0") {
                        ...
                        uploadFailed = true;
                        self._showUploadError(data.error_info, params);
            ...
            fnError = function (jqXHR, textStatus, errorThrown) {
                ...
                // 自定义修改个性化操作提示
                errMsg = self._parseError(op, jqXHR, errorThrown, (isBatch && self.filestack[i].name ? "系统异常，请重新上传" : null));
                uploadFailed = true;
                setTimeout(function () {
                    if (isBatch) {
        ...
        _change: function (e) {
            ...
            if(self.initialPreview.length > 0){
            	total = total + self.initialPreview.length;
            }

 ...
 */
@Controller
@RequestMapping("/sms/ywSmsNotice")
public class YwSmsNoticeManage {
	...
	@RequestMapping
	public String ywSmsNoticeList(Model model){
...
//		map.putAll(MapUtil.toMap(ywSmsNotice));
		List<YwSmsNotice> list = ywSmsNoticeService.queryListPage(ywSmsNotice,start,end);
		map.put("error_no", "0");

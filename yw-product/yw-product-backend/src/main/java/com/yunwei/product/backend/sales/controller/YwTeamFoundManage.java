...
public class YwTeamFoundManage {
	...
	public String edit(YwTeamFound ywTeamFound,String op_type,Model model){
		...
		if(StringUtils.equals(op_type, "2")){
			YwTeamFound teamFound = ywTeamFoundService.query(ywTeamFound);
			teamFound.setNickname(Base32.decode(teamFound.getNickname()));
			model.addAttribute("ywTeamFound", teamFound);
		} else {
	...
	@ResponseBody
	public Map<String,Object> deleteBatch(YwTeamFound ywTeamFound,String found_ids){
		Map<String,Object> map = new HashMap<String, Object>();
		String[] strings = found_ids.split(",");
		Map<String, String[]> strMap = new HashMap<String, String[]>();
		strMap.put("found_id",strings);
		ywTeamFoundService.deleteBatch(strMap);
		map.put("error_no", "0");
		map.put("error_info", "删除成功");
		return map;
	}

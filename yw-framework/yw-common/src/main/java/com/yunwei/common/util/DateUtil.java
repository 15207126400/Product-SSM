...
public class DateUtil extends DateUtils {
	...
	public static final String DATE_FORMAT_IS_YEAR = "yyyy";
	 ...
	 * @return boolen类型，true表示在两者间，false表示不在两者之间
	 */
	public static boolean isDayIn(Date time, Date begin, Date end) {
		
		return getIntervalDay(begin, time) >= 0 && getIntervalDay(time, end) >= 0;
	}

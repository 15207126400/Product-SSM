...
public class TripleDes {
	...
	static Logger logger = LoggerFactory.getLogger(TripleDes.class);
	...
	public static final byte[] CRH_KEY = new byte[] {0x02, 0x04, 0x06, 0x08, 0x10, 0x12, 0x14, 0x16, (byte)0x99, (byte)0x97, (byte)0x95, (byte)0x93, (byte)0x91, (byte)0x89, (byte)0x87, (byte)0x85,
			0x02, 0x04, 0x06, 0x08, 0x10, 0x12, 0x14, 0x16};

	private static byte[] getKeyBytes() {
		byte[] keyBytes = null;
//		String securityStr = PropertiesUtils.get("security.alias", "");
//		if (securityStr.equals("cfzq") || securityStr.equals("cfsecu")) {
...
//		}
	...
	public static String encode(String src) {
		...
		return encryptMode(getKeyBytes(), src);
	}
	...
	public static String decode(String src) {
		...
		return decryptMode(getKeyBytes(), src);
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println();
			System.out.println(encode(TripleDes.CRH_KEY,"cairenhui"));
			System.out.println(encode(TripleDes.CRH_KEY,"customer"));

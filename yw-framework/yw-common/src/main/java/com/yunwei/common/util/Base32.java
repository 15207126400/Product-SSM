...
public final class Base32 {
	...
	private static final char[] base32Chars = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', '2', '3', '4', '5',
			'6', '7'};
	...
	public static String encode(String s) {
		return encode(s, defaultStringEncoding);
	}
	...
	public static String decode(String s) {
		return decode(s, defaultStringEncoding);
	}
	 ...
	 */
	public static byte[] decodeBytes(final String base32) {

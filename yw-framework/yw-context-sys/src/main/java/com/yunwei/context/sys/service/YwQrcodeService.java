...
/**
 * 云维二维码服务接口
* @ClassName: YwQrcodeService 
* @Description: TODO(TODO) 
* @author zhangjh
* @date 2019年2月21日 下午5:30:42 
*
 */
public interface YwQrcodeService {

	/**
	 * 获取小程序码，适用于需要的码数量较少的业务场景。通过该接口生成的小程序码，永久有效，有数量限制
	 * @param appid 小程序编号 【必填】
	 ...
	 * @return
	 */
	public byte[] getWXACode(String appid,String path,int width,boolean auto_color,JSONObject line_color,boolean is_hyaline);
	 ...
	 * @return
	 */
	public byte[] getWXACodeUnlimit(String appid,String scene,String page,int width,boolean auto_color,JSONObject line_color,boolean is_hyaline);
